...
export class Window {
  ...
  constructor(Parent: BrowserWindow | undefined, Width: number, Height: number, IsSplash: boolean = false, UseNode: boolean = true) {
    ...
    this.Target?.webContents.on('did-navigate', () => { this.Target?.webContents.insertCSS('body { --primary: #6f6f6f; --successBackground: #49b920; --secondaryBorder: transparent; --secondaryBackground: #1F1F20; --gray200: #cfcfcf; --gray300: #8f8f8f; --gray400: #e5e5e5; --gray500: #bfbfbf; --gray600: #303030; --gray700: #202020; --gray800: #101010; --gray900: #101010; --gray700-default: #0f0f0f; }'); });
  }
